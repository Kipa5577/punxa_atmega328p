...
class MainFSM(py4hw.Logic):
    def __init__(self, parent, name,
        ...
        self.reset = self.addIn('reset', MAIN_Reset)  # always driven by a real wire in this project (see report)
        ...
        self._boundary_checked = 0  # was False; int form required for the stock transpiler's __init__ parser (see report)
    ...
    def clock(self):
        if self.reset.get():  # reset is always driven by a real wire in this project (see report)
            ...
            if ((instruction == 34) or (instruction == 107) or (instruction == 119) or (instruction == 31)) and self.current_state != 1:
                jump_width = 1
            else:
                jump_width = 0
            ...
            if state == 0:
                ...
                if instruction == 129:
                    ...
                    next_state = 5
                elif (((instruction == 128) or ((instruction == 130) or (instruction == 131)))):
