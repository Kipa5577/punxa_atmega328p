...
#   9 = 'FETCH_VEC_L_ISSUE'
#   10 = 'FETCH_VEC_L_WAIT'
#   11 = 'FETCH_VEC_L_LATCH'
#   12 = 'FETCH_VEC_L_STORE'
#   13 = 'FETCH_VEC_H_ISSUE'
#   14 = 'FETCH_VEC_H_WAIT'
#   15 = 'FETCH_VEC_H_LATCH'
#   16 = 'FETCH_VEC_H_STORE'
#   17 = 'SIGNAL_DONE'
#   18 = 'RETI_POP_L_WAIT'
#   19 = 'RETI_POP_L_LATCH'
#   20 = 'RETI_POP_L_STORE'
...
class InterruptFSM(py4hw.Logic):
    ...
    def clock(self):
        if self.reset.get():  # reset is always driven by a real wire in this project (see report)
            ...
            if (((state == 1) or ((state == 2) or ((state == 4) or ((state == 5) or ((state == 6) or ((state == 7) or ((state == 8) or ((state == 9) or ((state == 10) or ((state == 11) or ((state == 12) or ((state == 13) or ((state == 14) or ((state == 15) or ((state == 16) or (state == 17))))))))))))))))):
                I_Force_WE = 1
                I_Force_Value = 0
