...
#   0 = 'STOP'
#   1 = 'FETCH_FROM_STACK_POINTER'
#   2 = 'WAIT_FETCH_FROM_STACK_POINTER'
#   3 = 'LOAD_VALUE_TO_RD'
#   4 = 'WAIT_LOAD_VALUE_TO_RD'
#   5 = 'FETCH_RD'
#   6 = 'WAIT_FETCH_RD'
#   7 = 'LOAD_VALUE_TO_STACK'
#   8 = 'WAIT_LOAD_VALUE_TO_STACK'
    ...
    def clock(self):
        if self.reset.get():  # reset is always driven by a real wire in this project (see report)
            ...
            if self.debug and (self.current_state != 0):
                print(f"POPPUSH_TRACE | "
                    f"State: {self.current_state} -> {next_state} | "
                    f"Run: {run_active} Resp: {resp} | "
